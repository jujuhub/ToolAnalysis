...
export ROOT_INCLUDE_PATH=`pwd`/UserTools/PlotWaveforms:${ToolDAQapp}/ToolDAQ/WCSimLib/include/:${ToolDAQapp}/ToolDAQ/MrdTrackLib/include:${ToolDAQapp}/ToolDAQ/RATEventLib/include/:$ROOT_INCLUDE_PATH
