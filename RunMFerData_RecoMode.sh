...
do
  ...
  filelist="/annie/app/users/jhe/MyToolAnalysis_MFer/configfiles/MuonFitter/my_inputs_R${RUN}_filtered.txt"
  ...
  sed -i "19s#.*#TankTrackFitFile fitbyeye_R${RUN}_ctime.txt#" configfiles/MuonFitter/Data/MuonFitterConfig
  ...
  do
    ...
    sed -i "3s#.*#OutputFile MuonFitter_Reco_R${RUN}_${i}.root#" configfiles/MuonFitter/Data/MuonFitterConfig
    ...
    ./Analyse MuonFitter
          ...
          mv MuonFitter_Reco_R${RUN}_${i}.root /pnfs/annie/scratch/users/jhe/data/
